...
public class SendEmail {  
     ...
     * @return 
     */  
    public static com.hubers.utils.SendEmail entity(String smtpHost, String sendUserName, String sendUserPass, String to, String cc, String mailSubject, String mailBody,
                                                              List<String> attachments) {
        return new com.hubers.utils.SendEmail(smtpHost, sendUserName, sendUserPass, to, cc, mailSubject, mailBody, attachments);
    }  
	...
	public static <E> void sendEmail(HashMap<String, Object> hasMap,String mailConfigPath) {
		...
		try {
	        ...
	        com.hubers.utils.SendEmail email = com.hubers.utils.SendEmail.entity(smtpHost, userName, password, to, cc, subject, body, attachments);
		}
		catch(Exception e) {
			Log4jUtil.error(e);
		}
